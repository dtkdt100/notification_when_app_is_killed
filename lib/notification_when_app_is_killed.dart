...
class NotificationWhenAppIsKilled {
  Future<bool?> setNotificationOnKillService(ArgsForKillNotification argsForKillNotification) async {
    ...
    return NotificationWhenAppIsKilledPlatform.instance.setNotificationOnKillService(argsForKillNotification);
  }

  Future<bool?> cancelNotificationOnKillService() async {
    return NotificationWhenAppIsKilledPlatform.instance.cancelNotificationOnKillService();
  }
}
